...
import { QuestionAnsweringAgent } from "./question-answering-agent";
...
export class QuestionAskingAgent extends BaseAgent {
  ...
  private qaAgent: QuestionAnsweringAgent;
   ...
   */
  private async getAnswersToQuestions(
    questions: string[], 
    documentType: 'company' | 'source' | 'all' = 'all'
    ...
    try {
      ...
      for (const question of questions) {
        ...
        const request = QuestionAnsweringAgent.formatQuestionMessage(question, documentType as any);
